...
INSTALL_BROWSER_SECURITY_PLUGINS(){
	...
	apt-get install xul-ext-noscript xul-ext-requestpolicy xul-ext-cookie-monster xul-ext-useragentswitcher xul-ext-adblock-plus xul-ext-refcontrol xul-ext-https-everywhere xul-ext-foxyproxy-standard
